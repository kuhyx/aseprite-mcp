"""Coverage gaps in pixel_read.py not hit by other test modules.

Not hit by test_composite_read.py or test_error_propagation.py:
validation guards, successful get_pixels_rect, and out-of-range frame
indices.
...
def test_get_pixel_color_missing_file() -> None:
...
def test_get_pixels_rect_missing_file() -> None:
    result = run(
...
def test_get_pixels_rect_bad_dims(sprite: str) -> None:
    result = run(pixel_read.get_pixels_rect(sprite, 0, 0, 0, 4))
    assert "must be > 0" in result


def test_get_pixels_rect_success(sprite: str) -> None:
...
def test_get_composite_pixel_missing_file() -> None:
    result = run(pixel_read.get_composite_pixel("/tmp/ase-pytest/nope.aseprite", 0, 0))
    assert "not found" in result


def test_get_composite_pixel_frame_out_of_range(sprite: str) -> None:
...
def test_get_composite_rect_missing_file() -> None:
    result = run(
...
def test_get_composite_rect_bad_dims(sprite: str) -> None:
    result = run(pixel_read.get_composite_rect(sprite, 0, 0, 4, 0))
    assert "must be > 0" in result


def test_get_composite_rect_frame_out_of_range(sprite: str) -> None:
...
def test_get_pixel_color_reports_subprocess_failure(sprite: str) -> None:
...
def test_get_pixels_rect_reports_subprocess_failure(sprite: str) -> None:
    with patch("aseprite_mcp.tools.pixel_read.AsepriteCommand.execute_lua_script") as m:
        m.return_value = (False, "boom")
...
def test_get_composite_pixel_reports_subprocess_failure(sprite: str) -> None:
    with patch("aseprite_mcp.tools.pixel_read.AsepriteCommand.execute_lua_script") as m:
        m.return_value = (False, "boom")
...
def test_get_composite_rect_reports_subprocess_failure(sprite: str) -> None:
    with patch("aseprite_mcp.tools.pixel_read.AsepriteCommand.execute_lua_script") as m:
        m.return_value = (False, "boom")
...
def test_get_pixel_color_no_pixel_data_returned(sprite: str) -> None:
    with patch("aseprite_mcp.tools.pixel_read.AsepriteCommand.execute_lua_script") as m:
...
def test_get_pixels_rect_no_pixel_data_returned(sprite: str) -> None:
    with patch("aseprite_mcp.tools.pixel_read.AsepriteCommand.execute_lua_script") as m:
        m.return_value = (True, "nothing useful here")
        result = run(pixel_read.get_pixels_rect(sprite, 0, 0, 2, 2))
    assert result == "No pixel data returned"
...
def test_get_composite_pixel_no_pixel_data_returned(sprite: str) -> None:
    with patch("aseprite_mcp.tools.pixel_read.AsepriteCommand.execute_lua_script") as m:
        m.return_value = (True, "nothing useful here")
        result = run(pixel_read.get_composite_pixel(sprite, 0, 0))
    assert result == "No pixel data returned"
...
def test_get_composite_rect_no_pixel_data_returned(sprite: str) -> None:
    with patch("aseprite_mcp.tools.pixel_read.AsepriteCommand.execute_lua_script") as m:
        m.return_value = (True, "nothing useful here")
        result = run(pixel_read.get_composite_rect(sprite, 0, 0, 2, 2))
    assert result == "No pixel data returned"
